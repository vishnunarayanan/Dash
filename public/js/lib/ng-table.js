    ...
    return {
      ...
      controller: [
        "$scope", "$timeout", function($scope, $timeout) {
          ...
          updateParams = function(newParams) {
            ...
            $scope.paramsModel.assign($scope.$parent.$parent, new ngTableParams(newParams));
      ...
      compile: function(element, attrs) {
        ...
        return function(scope, element, attrs) {
          ...
          scope.$parent.$parent.$watch(attrs.ngTable, (function(params) {
          ...
          if (attrs.showFilter) {
            scope.$parent.$parent.$watch(attrs.showFilter, function(value) {
